...
class CardController extends Controller
{
    ...
    public function cardAuthorize(Request $request): View|RedirectResponse
    {
        ...
        if ($response_data instanceof CardAuthorizeResponseDto) {
            ...
            return redirect()->action([CardController::class, "authorizeResult"], ['orderId' => $request->request->get("orderId")]);
        }
    ...
    public function authorizeResult($orderId): View
    {
